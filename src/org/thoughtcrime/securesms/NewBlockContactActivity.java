 ...
 *
 */
public class NewBlockContactActivity extends PassphraseRequiredSherlockFragmentActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.new_block_contact_activity);
        initializeResources();
    }
    ...
    private Recipients contactDataToRecipients(ContactData contactData) {
        ...
        for (ContactAccessor.NumberData numberData : contactData.numbers) {
            if (NumberUtil.isValidSmsOrEmailOrGroup(numberData.number)) {
                try {
                    Recipients recipientsForNumber = RecipientFactory.getRecipientsFromString(NewBlockContactActivity.this,
                            numberData.number,
                            false);
    ...
    private void openNewConversation(Recipients recipients) {
        if (recipients != null) {
            //tropopoihsh na mpainei sthn database
            Intent intent = new Intent(this, BlackListActivity.class);
            //DatabaseFactory.getBlackListDatabase(this).saveBlockNumber(recipients);

...
import android.content.SharedPreferences; // Import SharedPreferences into the class
...
import android.preference.PreferenceManager; // Import PreferenceManager into the class
...
import org.thoughtcrime.securesms.util.FontStyle; // Import FontStyle class
    ...
    implements ConversationFragment.ConversationFragmentListener
{
  ...
  protected void onCreate(Bundle state) {
    ...
    // Get font size that has been set from the settings and apply it
